                        ...
                        <div className="row">
                            <div className="col-md-4 sm-4">
                                <div className="card text-center oneheight">
                                    ...
                                    <h3><CountUp start={0} end={confirmed.value} duration ={10} separator =","/></h3>
                                    <h5 className="text">{new Date(lastUpdate).toDateString()}</h5>
                                    <h3>Active cases</h3>
                                </div>    
                            </div>
                            ...
                            <div className="col-md-4 sm-4">
                                <div className="card text-center twoheight">
                                    ...
                                    <h3><CountUp start={0} end={recovered.value} duration ={7} separator =","/></h3>
                                    <h5 className="text">{new Date(lastUpdate).toDateString()}</h5>
                            ...
                            <div className="col-md-4 sm-4">
                                <div className="card text-center threeheight">
                                    ...
                                    <h3><CountUp start={0} end={deaths.value} duration ={5} separator =","/></h3>
                                    <h5 className="text">{new Date(lastUpdate).toDateString()}</h5>
                                    <h3>Death Counts</h3>
                                </div>    
                            </div>
